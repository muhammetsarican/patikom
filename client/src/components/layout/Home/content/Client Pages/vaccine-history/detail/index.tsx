...
export default () => {
    const { currentVaccine } = useVaccineData();
        ...
        <div id="operation-item"
            ...
            <div id="header"
                ...
                <div id="header-title" className="flex gap-3 items-center h-9 py-1">
                    ...
                    <h1 className="font-sora text-lg sm:text-xl">Kayıtlı Aşılar / Kayıt Detayı / {currentVaccine._id}</h1>
                </div>
            </div>
                    ...
                    <form action=""
                        ...
                        <div className="grid grid-cols-2 gap-3 h-fit">
                            <p
                                ...
                                Adı:{currentVaccine.name}</p>
                            <p
                                className="col-span-2 border rounded-xl p-4 w-full text-xs outline-none focus:outline-offset-0 focus:outline focus:outline-primary">
                                Anahtar Kelime:{currentVaccine.keyword}</p>
                            <p
                                className="col-span-2 border rounded-xl p-4 w-full text-xs outline-none focus:outline-offset-0 focus:outline focus:outline-primary">
                                Açıklama:{currentVaccine.description}</p>
                        </div>
                    </form>
                </div>
            </div>
