...
export default () => {
    const { createSubmit } = useVaccineData();

    const schema = yup.object({
        name: yup.string().required("İsim alanı zorunlu bir alandır."),
        keyword: yup.string(),
        ...
        <div id="operation-item"
            ...
            <div id="header"
                ...
                <div id="header-title" className="flex gap-3 items-center h-9 py-1">
                    ...
                    <h1 className="font-sora text-lg sm:text-xl">Kayıtlı Aşılar / Yeni Kayıt</h1>
                </div>
            </div>
