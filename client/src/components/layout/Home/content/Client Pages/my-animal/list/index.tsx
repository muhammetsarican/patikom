        ...
        <div id="operation-item"
            ...
            <div className="px-6">
                <div className="rounded-lg overflow-hidden border">
                    {!animalArray && <NoRecord />}
                    {animalArray && <table className="w-full text-xs sm:text-sm">
                        <thead className="bg-slate-50 text-accent-text">
                            <tr className="uppercase">
                                <th className="py-4">adı</th>
                                <th className="py-4">anne adı</th>
                                <th className="py-4">ırkı</th>
                                <th className="py-4">cinsiyeti</th>
                                <th className="py-4">doğum tarihi</th>
                                <th className="py-4">çip durumu</th>
                                <th className="py-4" colSpan={2}>işlemler</th>
                            </tr>
                        </thead>
                        <tbody className="bg-white text-primary-text capitalize">
                            {animalArray && animalArray.map(animal => (
                                <ListItem props={props} animal={animal} />
                            ))}
                        </tbody>
                        {animalArray && animalArray.length > 9 && <tfoot className="bg-slate-50 text-accent-text">
                            <tr className="uppercase">
